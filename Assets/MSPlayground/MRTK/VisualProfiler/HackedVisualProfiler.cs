...
/// <summary>
/// Hacked version of Visual Profiler, because the subsystem doesn't currently load properly on MRTK3
/// </summary>
/// 
namespace MSPlayground.Core
{
    ...
    /// </summary>
    public class HackedVisualProfiler : MonoBehaviour
    {
        ...
        private Coroutine m_frameCountRoutine;
        [SerializeField] float _frequency = 0.25f;
        ...
        void Update()
        {
            if (m_frameCountRoutine == null)
            {
                m_frameCountRoutine = StartCoroutine(CalcFps());
            }
        }

        /// <summary>
        /// Every frequency seconds recalculate FramesPerSec over the same duration
        /// </summary>
        /// <returns></returns>
        ...
        public void LateUpdate()
        {
            ...
            //if (PerformanceStatsHelpers.Subsystem != null)
            {
                ...
                cpuFrameRateText.text = cpuFrameRateStrings[Mathf.Clamp(FramesPerSec, 0, maxTargetFrameRate)];
                ...
                frameInfoColors[0] = (FramesPerSec < ((int)(AppFrameRate) - 1)) ? missedFrameRateColor : targetFrameRateColor;
